package com.mc.algorism.sec04.map;

import com.mc.algorism.sec04.list.Node;
import com.mc.algorism.sec04.list._LinkedList;
import com.mc.algorism.sec04.set._HashSet_P3;
...
public class _HashMap<K, V> {
    ...
    public Object[] arrayEntry(String s){
        int count;
